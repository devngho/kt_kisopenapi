...
interface BalanceAccountStock : Response, StockPriceBase, Ticker {
    ...
    /** 대출 실행 일자
     *
     * [io.github.devngho.kisopenapi.requests.InquireBalance]로 이를 조회할 때, [io.github.devngho.kisopenapi.requests.InquireBalance.InquireBalanceData.inquireDivision]를
