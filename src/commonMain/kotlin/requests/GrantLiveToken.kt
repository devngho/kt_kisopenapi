...
class GrantLiveToken(override val client: KisOpenApi): NoDataRequest<GrantLiveToken.GrantTokenResponse> {
    @Serializable
    data class GrantTokenResponse(val approval_key: String): Response {
    ...
    override suspend fun call(): GrantTokenResponse {
        return client.httpClient.post(
            if (client.isDemo) "https://openapi.koreainvestment.com:9443/oauth2/Approval"
            else               "https://openapivts.koreainvestment.com:29443/oauth2/Approval"
        ) {
