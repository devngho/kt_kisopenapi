...
class InquireOverseasPrice(override val client: KisOpenApi):
    ...
    data class InquirePriceData(val stockCode: String, val market: OverseasMarket, override var corp: CorporationRequest? = null, override val tradeContinuous: String? = ""): Data, TradeContinuousData
