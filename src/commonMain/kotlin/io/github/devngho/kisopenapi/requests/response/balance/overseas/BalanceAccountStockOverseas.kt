...
interface BalanceAccountStockOverseas : Response, StockOverseasPriceBase, Ticker {
    ...
    /** 상품명 */
    @SerialName("ovrs_item_name")
    val productName: String?

    /** 보유 수량 */
    @SerialName("ovrs_cblc_qty")
    @Contextual
     ...
     */
    @SerialName("frcr_evlu_pfls_amt")
    @Contextual
    val evalProfitLossAmount: BigDecimal?
