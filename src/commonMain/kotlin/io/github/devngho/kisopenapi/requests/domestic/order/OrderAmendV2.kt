 ...
 */
class OrderAmendV2(override val client: KISApiClient) :
    DataRequest<OrderAmendV2.OrderDataV2, OrderAmend.OrderResponse> {
    ...
    @Suppress("SpellCheckingInspection")
    override suspend fun call(data: OrderDataV2): Result<OrderAmend.OrderResponse> {
